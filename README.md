...
- 基于 libca HTTP/net 的 buffered Streamable HTTP server、Origin allowlist、authorization hook
  与并发 session 管理。

Streamable HTTP 的 SSE/resumability、HTTPS 和 resources/prompts feature registry 将在后续
增量加入。
